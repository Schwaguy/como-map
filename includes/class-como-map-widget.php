...
class Como_Map_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$name 					= esc_html__( 'Como map', 'como-map' );
		$opts['classname'] 		= '';
		$opts['description'] 	= esc_html__( 'Display map postings on a sidebar', 'como-map' );
	...
	function widget( $args, $instance ) {
		...
		ob_start();
		include( plugin_dir_path( __FILE__ ) . 'partials/como-map-display-widget.php' );
